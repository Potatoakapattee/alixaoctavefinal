        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/Iink_ka_adda) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
@app.on_message(commandpro(["/alive", "Octave"]))
...
async def verify(client, message: Message):
    ...
    await add_served_user(message.from_user.id)
    await message.reply_photo(
        photo=f"https://graph.org/file/91220284ae0d2a6779b21.mp4",
